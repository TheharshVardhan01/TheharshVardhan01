...
<sub>All art on this page is animated SVG generated by <a href="./scripts">a handful of Python scripts</a> —
no JavaScript, no tokens, no third-party stats services. The heatmap refreshes itself daily via
